...
ggplot(crime_map) +
  ...
  labs(
    title = "US Murder Rate by State — 2019",
    caption = "Top 25% states highlighted in red"
  ) +
  theme_minimal()
```
Regarding an analysis of the map, it seems as if many of the southern US states have high murder rates, including others such as Missouri (likely due to St. Louis), Illinois (likely due to Chicago), and New Mexico (possibly due to the prevalence of drug related crime and Albuquerque). Interestingly enough, Alaska also made the cut, which I would be interested in doing more research into the fact to find out why.
